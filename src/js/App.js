...
class App extends FinderApp {
  ready(features) {
    ...
    let bannerHTML = $('.fnd #banner>span')[0].innerHTML
  ...
  checkBanner(bannerHTML) {
    $('.fnd #banner>span')[0].innerHTML = parseInt($('.fnd #banner>span').css('font-size')) <  16 || $(window).width() < 500 ? bannerHTML.replace('locator', '') : bannerHTML
  }
}
